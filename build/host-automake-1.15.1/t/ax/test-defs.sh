...
am_rel_srcdir='.'
am_top_srcdir='/home/lagadanu/devel/optee/qemu/out-br/build/host-automake-1.15.1'
am_top_builddir='/home/lagadanu/devel/optee/qemu/out-br/build/host-automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/lagadanu/devel/optee/qemu/out-br/host/share/automake-1.15/am'
    am_automake_acdir='/home/lagadanu/devel/optee/qemu/out-br/host/share/aclocal-1.15'
    am_bindir='/home/lagadanu/devel/optee/qemu/out-br/host/bin'
    am_datadir='/home/lagadanu/devel/optee/qemu/out-br/host/share'
    am_docdir='/home/lagadanu/devel/optee/qemu/out-br/host/share/doc/automake'
    am_pkgvdatadir='/home/lagadanu/devel/optee/qemu/out-br/host/share/automake-1.15'
    am_scriptdir='/home/lagadanu/devel/optee/qemu/out-br/host/share/automake-1.15'
    am_system_acdir='/home/lagadanu/devel/optee/qemu/out-br/host/share/aclocal'
    ;;
  no)
...
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  CC=${AM_TESTSUITE_CC-${CC-'/home/lagadanu/devel/optee/qemu/out-br/host/bin/ccache /usr/bin/gcc'}}
else
  CC=$am_testaux_builddir/cc-no-c-o
fi
CXX=${AM_TESTSUITE_CXX-${CXX-'/home/lagadanu/devel/optee/qemu/out-br/host/bin/ccache /usr/bin/g++'}}
F77=${AM_TESTSUITE_F77-${F77-'false'}}
FC=${AM_TESTSUITE_FC-${FC-'false'}}
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/lagadanu/devel/optee/qemu/out-br/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/lagadanu/devel/optee/qemu/out-br/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/lagadanu/devel/optee/qemu/out-br/host/include'}}

# GNU compilers and their flags.
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/home/lagadanu/devel/optee/qemu/out-br/host/bin/ccache /usr/bin/gcc'}}
else
  GNU_CC=$am_testaux_builddir/cc-no-c-o
fi
GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/home/lagadanu/devel/optee/qemu/out-br/host/bin/ccache /usr/bin/gcc'}}
GNU_CXX=${AM_TESTSUITE_GNU_CXX-${GNU_CXX-'/home/lagadanu/devel/optee/qemu/out-br/host/bin/ccache /usr/bin/g++'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/lagadanu/devel/optee/qemu/out-br/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/lagadanu/devel/optee/qemu/out-br/host/include'}}
