...
Currently available applets include:
	...
	gunzip, gzip, halt, hdparm, head, hexdump, hexedit, hostid,
	...
	mesg, microcom, mkdir, mkdosfs, mke2fs, mkfifo, mknod, mkpasswd,
	mkswap, mktemp, modprobe, more, mount, mountpoint, mt, mv, nameif,
	netstat, nice, nl, nohup, nproc, nslookup, nuke, od, openvt,
	...
	rmdir, rmmod, route, run-init, run-parts, runlevel, sed, seq,
	setarch, setconsole, setfattr, setkeycodes, setlogcons, setpriv,
	setserial, setsid, sh, sha1sum, sha256sum, sha3sum, sha512sum,
	shred, sleep, sort, start-stop-daemon, strings, stty, su, sulogin,
	svc, swapoff, swapon, switch_root, sync, sysctl, syslogd, tail, tar,
...
tar c|x|t [-hvO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [--exclude PATTERN]... [FILE]...
