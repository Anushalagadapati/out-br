...
struct tcb {
 ...
 struct inject_opts *inject_vec[2];
...
extern _Bool printnum_addr_long_int(struct tcb *, kernel_ulong_t addr);
extern _Bool printnum_addr_klong_int(struct tcb *, kernel_ulong_t addr);
...
extern struct inject_opts *inject_vec[2];
static inline _Bool
...
scno_is_valid(kernel_ulong_t scno)
{
 return scno_in_range(scno)
        ...
        && !(sysent[scno].sys_flags & 00002000);
}
...
print_blkpg_req(struct tcb *tcp, const struct_blkpg_ioctl_arg *blkpg)
{
 ...
 do { tprintf("%s%s=", ("{"), "op"); printxval64((blkpg_ops), (sizeof((*blkpg).op) == sizeof(char) ? (unsigned long long) (unsigned char) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(short) ? (unsigned long long) (unsigned short) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(int) ? (unsigned long long) (unsigned int) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(long) ? (unsigned long long) (unsigned long) ((*blkpg).op) : (unsigned long long) ((*blkpg).op)), ("BLKPG_???")); } while (0);
 tprintf("%s%s=%lld", (", "), "flags", (sizeof((*blkpg).flags) == sizeof(char) ? (long long) (char) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(short) ? (long long) (short) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(int) ? (long long) (int) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(long) ? (long long) (long) ((*blkpg).flags) : (long long) ((*blkpg).flags)));
 tprintf("%s%s=%lld", (", "), "datalen", (sizeof((*blkpg).datalen) == sizeof(char) ? (long long) (char) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(short) ? (long long) (short) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(int) ? (long long) (int) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(long) ? (long long) (long) ((*blkpg).datalen) : (long long) ((*blkpg).datalen)));
 tprints(", data=");
 if (!umoven_or_printaddr((tcp), (((kernel_ulong_t) (unsigned long) (blkpg->data))), sizeof(*(&p)), (void *) (&p))) {
  tprintf("%s%s=%lld", ("{"), "start", (sizeof((p).start) == sizeof(char) ? (long long) (char) ((p).start) : sizeof((p).start) == sizeof(short) ? (long long) (short) ((p).start) : sizeof((p).start) == sizeof(int) ? (long long) (int) ((p).start) : sizeof((p).start) == sizeof(long) ? (long long) (long) ((p).start) : (long long) ((p).start)));
  tprintf("%s%s=%lld", (", "), "length", (sizeof((p).length) == sizeof(char) ? (long long) (char) ((p).length) : sizeof((p).length) == sizeof(short) ? (long long) (short) ((p).length) : sizeof((p).length) == sizeof(int) ? (long long) (int) ((p).length) : sizeof((p).length) == sizeof(long) ? (long long) (long) ((p).length) : (long long) ((p).length)));
  tprintf("%s%s=%lld", (", "), "pno", (sizeof((p).pno) == sizeof(char) ? (long long) (char) ((p).pno) : sizeof((p).pno) == sizeof(short) ? (long long) (short) ((p).pno) : sizeof((p).pno) == sizeof(int) ? (long long) (int) ((p).pno) : sizeof((p).pno) == sizeof(long) ? (long long) (long) ((p).pno) : (long long) ((p).pno)));
  do { tprintf("%s%s=", (", "), "devname"); print_quoted_cstring((const char *)(p).devname, sizeof((p).devname)); } while (0);
  do { tprintf("%s%s=", (", "), "volname"); print_quoted_cstring((const char *)(p).volname, sizeof((p).volname)); } while (0);
  tprints("}");
 }
 tprints("}");
}
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((115)) << 0) | ((((sizeof(struct blk_user_trace_setup)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (umoven_or_printaddr((tcp), (arg), sizeof(*(&buts)), (void *) (&buts)))
    break;
   tprintf("%s%s=%llu", ("{"), "act_mask", (sizeof((buts).act_mask) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).act_mask) : (unsigned long long) ((buts).act_mask)));
   tprintf("%s%s=%llu", (", "), "buf_size", (sizeof((buts).buf_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_size) : (unsigned long long) ((buts).buf_size)));
   tprintf("%s%s=%llu", (", "), "buf_nr", (sizeof((buts).buf_nr) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_nr) : (unsigned long long) ((buts).buf_nr)));
   tprintf("%s%s=%llu", (", "), "start_lba", (sizeof((buts).start_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).start_lba) : (unsigned long long) ((buts).start_lba)));
   tprintf("%s%s=%llu", (", "), "end_lba", (sizeof((buts).end_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).end_lba) : (unsigned long long) ((buts).end_lba)));
   tprintf("%s%s=%llu", (", "), "pid", (sizeof((buts).pid) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).pid) : sizeof((buts).pid) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).pid) : sizeof((buts).pid) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).pid) : sizeof((buts).pid) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).pid) : (unsigned long long) ((buts).pid)));
   return 0;
  } else {
   struct_blk_user_trace_setup buts;
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&buts)), (void *) (&buts)))
    do { tprintf("%s%s=", (", "), "name"); print_quoted_cstring((const char *)(buts).name, sizeof((buts).name)); } while (0);
   tprints("}");
   break;
  }
