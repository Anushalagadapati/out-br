 ...
 if ((!((tcp)->flags & 0x04)))
  ...
  if (!umoven_or_printaddr((tcp), (tcp->u_arg[1]), sizeof(*(&ust)), (void *) (&ust)))
   tprintf("{f_tfree=%llu, f_tinode=%llu}",
    (sizeof(ust.f_tfree) == sizeof(char) ? (unsigned long long) (unsigned char) (ust.f_tfree) : sizeof(ust.f_tfree) == sizeof(short) ? (unsigned long long) (unsigned short) (ust.f_tfree) : sizeof(ust.f_tfree) == sizeof(int) ? (unsigned long long) (unsigned int) (ust.f_tfree) : sizeof(ust.f_tfree) == sizeof(long) ? (unsigned long long) (unsigned long) (ust.f_tfree) : (unsigned long long) (ust.f_tfree)),
    (sizeof(ust.f_tinode) == sizeof(char) ? (unsigned long long) (unsigned char) (ust.f_tinode) : sizeof(ust.f_tinode) == sizeof(short) ? (unsigned long long) (unsigned short) (ust.f_tinode) : sizeof(ust.f_tinode) == sizeof(int) ? (unsigned long long) (unsigned int) (ust.f_tinode) : sizeof(ust.f_tinode) == sizeof(long) ? (unsigned long long) (unsigned long) (ust.f_tinode) : (unsigned long long) (ust.f_tinode)));
 }
 return 0;
}
