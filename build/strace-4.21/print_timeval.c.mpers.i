...
MPERS_PRINTER_DECL(void, print_timeval, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t;
...
MPERS_PRINTER_DECL(void, print_timeval_utimes, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t[2];
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return;
...
MPERS_PRINTER_DECL(void, print_itimerval, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t[2];
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return;
