...
#endif
#ifdef KVM_ARM_PREFERRED_TARGET
# undef KVM_ARM_PREFERRED_TARGET
# define KVM_ARM_PREFERRED_TARGET 0x8020aeaf
#endif
#ifdef KVM_ARM_SET_DEVICE_ADDR
# undef KVM_ARM_SET_DEVICE_ADDR
# define KVM_ARM_SET_DEVICE_ADDR 0x4010aeab
#endif
#ifdef KVM_ARM_VCPU_INIT
# undef KVM_ARM_VCPU_INIT
# define KVM_ARM_VCPU_INIT 0x4020aeae
#endif
#ifdef KVM_ASSIGN_DEV_IRQ
# undef KVM_ASSIGN_DEV_IRQ
# define KVM_ASSIGN_DEV_IRQ 0x4040ae70
#endif
#ifdef KVM_ASSIGN_PCI_DEVICE
# undef KVM_ASSIGN_PCI_DEVICE
# define KVM_ASSIGN_PCI_DEVICE 0x8040ae69
#endif
#ifdef KVM_ASSIGN_SET_INTX_MASK
# undef KVM_ASSIGN_SET_INTX_MASK
# define KVM_ASSIGN_SET_INTX_MASK 0x4040aea4
#endif
#ifdef KVM_ASSIGN_SET_MSIX_ENTRY
# undef KVM_ASSIGN_SET_MSIX_ENTRY
# define KVM_ASSIGN_SET_MSIX_ENTRY 0x4010ae74
#endif
#ifdef KVM_ASSIGN_SET_MSIX_NR
# undef KVM_ASSIGN_SET_MSIX_NR
# define KVM_ASSIGN_SET_MSIX_NR 0x4008ae73
#endif
#ifdef KVM_CHECK_EXTENSION
# undef KVM_CHECK_EXTENSION
# define KVM_CHECK_EXTENSION 0x0000ae03
#endif
#ifdef KVM_CREATE_DEVICE
# undef KVM_CREATE_DEVICE
# define KVM_CREATE_DEVICE 0xc00caee0
#endif
#ifdef KVM_CREATE_IRQCHIP
# undef KVM_CREATE_IRQCHIP
# define KVM_CREATE_IRQCHIP 0x0000ae60
#endif
#ifdef KVM_CREATE_PIT
# undef KVM_CREATE_PIT
# define KVM_CREATE_PIT 0x0000ae64
#endif
#ifdef KVM_CREATE_PIT2
# undef KVM_CREATE_PIT2
# define KVM_CREATE_PIT2 0x4040ae77
#endif
#ifdef KVM_CREATE_VCPU
...
#endif
#ifdef KVM_DEASSIGN_DEV_IRQ
# undef KVM_DEASSIGN_DEV_IRQ
# define KVM_DEASSIGN_DEV_IRQ 0x4040ae75
#endif
#ifdef KVM_DEASSIGN_PCI_DEVICE
# undef KVM_DEASSIGN_PCI_DEVICE
...
# undef KVM_GET_DEVICE_ATTR
# define KVM_GET_DEVICE_ATTR 0x4018aee2
#endif
#ifdef KVM_GET_DIRTY_LOG
# undef KVM_GET_DIRTY_LOG
# define KVM_GET_DIRTY_LOG 0x4010ae42
#endif
#ifdef KVM_GET_FPU
# undef KVM_GET_FPU
# define KVM_GET_FPU 0x8000ae8c
#endif
#ifdef KVM_GET_IRQCHIP
# undef KVM_GET_IRQCHIP
# define KVM_GET_IRQCHIP 0xc208ae62
#endif
#ifdef KVM_GET_MP_STATE
# undef KVM_GET_MP_STATE
# define KVM_GET_MP_STATE 0x8004ae98
#endif
#ifdef KVM_GET_NR_MMU_PAGES
# undef KVM_GET_NR_MMU_PAGES
# define KVM_GET_NR_MMU_PAGES 0x0000ae45
#endif
#ifdef KVM_GET_ONE_REG
# undef KVM_GET_ONE_REG
# define KVM_GET_ONE_REG 0x4010aeab
#endif
#ifdef KVM_GET_REG_LIST
# undef KVM_GET_REG_LIST
...
#ifdef KVM_GET_SREGS
# undef KVM_GET_SREGS
# define KVM_GET_SREGS 0x8000ae83
#endif
#ifdef KVM_GET_TSC_KHZ
# undef KVM_GET_TSC_KHZ
# define KVM_GET_TSC_KHZ 0x0000aea3
#endif
#ifdef KVM_GET_VCPU_MMAP_SIZE
# undef KVM_GET_VCPU_MMAP_SIZE
# define KVM_GET_VCPU_MMAP_SIZE 0x0000ae04
#endif
#ifdef KVM_HAS_DEVICE_ATTR
# undef KVM_HAS_DEVICE_ATTR
...
#endif
#ifdef KVM_REGISTER_COALESCED_MMIO
# undef KVM_REGISTER_COALESCED_MMIO
# define KVM_REGISTER_COALESCED_MMIO 0x4010ae67
#endif
#ifdef KVM_REINJECT_CONTROL
# undef KVM_REINJECT_CONTROL
...
#endif
#ifdef KVM_SET_BOOT_CPU_ID
# undef KVM_SET_BOOT_CPU_ID
...
# undef KVM_SET_DEVICE_ATTR
# define KVM_SET_DEVICE_ATTR 0x4018aee1
#endif
#ifdef KVM_SET_FPU
# undef KVM_SET_FPU
# define KVM_SET_FPU 0x4000ae8d
#endif
#ifdef KVM_SET_GSI_ROUTING
# undef KVM_SET_GSI_ROUTING
...
#endif
#ifdef KVM_SET_SIGNAL_MASK
# undef KVM_SET_SIGNAL_MASK
# define KVM_SET_SIGNAL_MASK 0x4004ae8b
#endif
#ifdef KVM_SET_SREGS
# undef KVM_SET_SREGS
# define KVM_SET_SREGS 0x4000ae84
#endif
#ifdef KVM_SET_TSC_KHZ
# undef KVM_SET_TSC_KHZ
# define KVM_SET_TSC_KHZ 0x0000aea2
#endif
#ifdef KVM_SET_TSS_ADDR
# undef KVM_SET_TSS_ADDR
...
# undef KVM_SET_VAPIC_ADDR
# define KVM_SET_VAPIC_ADDR 0x4008ae93
#endif
#ifdef KVM_SIGNAL_MSI
# undef KVM_SIGNAL_MSI
# define KVM_SIGNAL_MSI 0x4020aea5
#endif
#ifdef KVM_SMI
# undef KVM_SMI
# define KVM_SMI 0x0000aeb7
#endif
#ifdef KVM_TPR_ACCESS_REPORTING
# undef KVM_TPR_ACCESS_REPORTING
...
#endif
#ifdef KVM_UNREGISTER_COALESCED_MMIO
# undef KVM_UNREGISTER_COALESCED_MMIO
