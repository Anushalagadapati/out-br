...
MPERS_PRINTER_DECL(void, printmqattr, struct tcb *const tcp, const kernel_ulong_t addr, const _Bool decode_flags)
{
 ...
 if (decode_flags)
  printflags64(mq_attr_flags,
        (sizeof(attr.mq_flags) == sizeof(char) ? (unsigned long long) (unsigned char) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(short) ? (unsigned long long) (unsigned short) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(int) ? (unsigned long long) (unsigned int) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(long) ? (unsigned long long) (unsigned long) (attr.mq_flags) : (unsigned long long) (attr.mq_flags)),
        "O_???");
 else
  tprintf("%#llx", (sizeof(attr.mq_flags) == sizeof(char) ? (unsigned long long) (unsigned char) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(short) ? (unsigned long long) (unsigned short) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(int) ? (unsigned long long) (unsigned int) (attr.mq_flags) : sizeof(attr.mq_flags) == sizeof(long) ? (unsigned long long) (unsigned long) (attr.mq_flags) : (unsigned long long) (attr.mq_flags)));
 tprintf(", mq_maxmsg=%lld, mq_msgsize=%lld, mq_curmsgs=%lld}",
  (sizeof(attr.mq_maxmsg) == sizeof(char) ? (long long) (char) (attr.mq_maxmsg) : sizeof(attr.mq_maxmsg) == sizeof(short) ? (long long) (short) (attr.mq_maxmsg) : sizeof(attr.mq_maxmsg) == sizeof(int) ? (long long) (int) (attr.mq_maxmsg) : sizeof(attr.mq_maxmsg) == sizeof(long) ? (long long) (long) (attr.mq_maxmsg) : (long long) (attr.mq_maxmsg)),
  (sizeof(attr.mq_msgsize) == sizeof(char) ? (long long) (char) (attr.mq_msgsize) : sizeof(attr.mq_msgsize) == sizeof(short) ? (long long) (short) (attr.mq_msgsize) : sizeof(attr.mq_msgsize) == sizeof(int) ? (long long) (int) (attr.mq_msgsize) : sizeof(attr.mq_msgsize) == sizeof(long) ? (long long) (long) (attr.mq_msgsize) : (long long) (attr.mq_msgsize)),
  (sizeof(attr.mq_curmsgs) == sizeof(char) ? (long long) (char) (attr.mq_curmsgs) : sizeof(attr.mq_curmsgs) == sizeof(short) ? (long long) (short) (attr.mq_curmsgs) : sizeof(attr.mq_curmsgs) == sizeof(int) ? (long long) (int) (attr.mq_curmsgs) : sizeof(attr.mq_curmsgs) == sizeof(long) ? (long long) (long) (attr.mq_curmsgs) : (long long) (attr.mq_curmsgs)));
}
