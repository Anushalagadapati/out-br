...
print_timespec_t(const timespec_t *t)
{
 tprintf(timespec_fmt, (long long) t->tv_sec,
  (sizeof(t->tv_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (t->tv_nsec) : sizeof(t->tv_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (t->tv_nsec) : sizeof(t->tv_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (t->tv_nsec) : sizeof(t->tv_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (t->tv_nsec) : (unsigned long long) (t->tv_nsec)));
}
static void
...
MPERS_PRINTER_DECL(_Bool, print_struct_timespec_data_size, const void *arg, const size_t size)
{
...
MPERS_PRINTER_DECL(_Bool, print_struct_timespec_array_data_size, const void *arg, const unsigned int nmemb, const size_t size)
{
...
MPERS_PRINTER_DECL(void, print_timespec, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timespec_t t;
...
MPERS_PRINTER_DECL(const char *, sprint_timespec, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timespec_t t;
 ...
 if (!addr) {
  ...
  xsnprintf_(((buf)), (sizeof(buf) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((buf)), typeof(&(buf)[0])))]) * 0)), __func__, "(timespec_fmt)" ", " "(long long) t.tv_sec, (sizeof(t.tv_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (t.tv_nsec) : (unsigned long long) (t.tv_nsec))", ((timespec_fmt)), (long long) t.tv_sec, (sizeof(t.tv_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (t.tv_nsec) : sizeof(t.tv_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (t.tv_nsec) : (unsigned long long) (t.tv_nsec)));
 }
 return buf;
}
MPERS_PRINTER_DECL(void, print_timespec_utime_pair, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timespec_t t[2];
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return;
...
MPERS_PRINTER_DECL(void, print_itimerspec, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timespec_t t[2];
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return;
